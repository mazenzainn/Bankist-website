...
const handleMenuHover = function (e) {
  if (e.target.classList.contains('nav__link')) {
    ...
    siblings.forEach(sibling => {
      // We don't choose the hovered elements
      if (sibling !== link) {
...
const stickyNav = function (entries) {
  const [entry] = entries;
  // the entry is a special kind of object that have the observer
...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null, // it relates to the entire viewport
  threshold: 0,
